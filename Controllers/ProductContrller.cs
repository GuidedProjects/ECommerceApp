...
namespace ECommerceApp.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        public async Task<ActionResult<ApiResponse<ConfirmationResponseDTO>>> UpdateProduct(
        ...
        public async Task<ActionResult<ApiResponse<ConfirmationResponseDTO>>> UpdateProductStatus(
